...
import static com.stdio.overridejsfunctionwithwebview.MainActivity.TAG;
...
public class MyWebViewClient extends WebViewClient {
    ...
    private String removeDialog() {
        return "var elements = document.getElementsByClassName('modal-content');\n" +
                "    while(elements.length > 0){\n" +
                "        elements[0].parentNode.removeChild(elements[0]);\n" +
                "    };";
    }

    private String removeShadow() {
        return "setTimeout(function () { var elements = document.getElementsByClassName('modal-backdrop fade in');\n" +
                "    while(elements.length > 0){\n" +
                "        elements[0].parentNode.removeChild(elements[0]);\n" +
                "    } }, 10);";
    }
